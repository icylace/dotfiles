# bsdtar
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/usr/share/man/man1/bsdtar.1
...
complete -c bsdtar -l check-links --description '(c and r modes only) Issue a warning message unless all links to each file ar…'
...
complete -c bsdtar -s H --description '(c and r mode only) Symbolic links named on the command line will be followed…'
...
complete -c bsdtar -l newer-mtime-than --description '(c, r, u modes only) Like -newer-than, except it compares mtime entries inste…'
complete -c bsdtar -l nodump --description '(c and r modes only) Honor the nodump file flag by skipping this file.'
complete -c bsdtar -l null --description '(use with I, T, or X ) Filenames or patterns are separated by null characters…'
complete -c bsdtar -l numeric-owner --description '(x mode only) Ignore symbolic user and group names when restoring archives to…'
...
complete -c bsdtar -l strip-components --description '(x mode only) Remove the specified number of leading path elements.'
