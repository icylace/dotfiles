...
complete -c ctest -l build-and-test --description 'Configure, build and run a test. sp This option tells ctest to configure (i.'
complete -c ctest -l build-target --description 'Specify a specific target to build.'
complete -c ctest -l build-nocmake --description 'Run the build without running cmake first. sp Skip the cmake step.'
...
complete -c ctest -l ctest-config --description 'The configuration file used to initialize CTest state when submitting dashboa…'
...
complete -c ctest -l 'http1.0' --description 'Submit using HTTP 1. 0. sp This option will force CTest to use HTTP 1.'
...
complete -c ctest -l 'build-options.' --description '.'
