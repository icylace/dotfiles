# curl
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/usr/share/man/man1/curl.1
...
complete -c curl -l connect-to --description 'For a request to the given "host:port" pair, connect to "connect-to-host:conn…'
