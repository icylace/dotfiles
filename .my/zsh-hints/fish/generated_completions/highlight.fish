# highlight
# Autogenerated from man page /usr/local/share/man/man1/highlight.1.gz
complete -c highlight -s B -l batch-recursive --description 'convert all files matching the wildcard (uses recursive search).'
complete -c highlight -s D -l data-dir --description 'set path to highlight data directory (deprecated).'
