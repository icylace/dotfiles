...
complete -c pgbench -s L --description 'Transaction which last more than limit milliseconds are counted and reported …'
...
complete -c pgbench -o 'f.' --description '@ so as to change its drawing probability.  The default weight is 1.'
