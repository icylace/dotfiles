# uname
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/usr/share/man/man1/uname.1
...
complete -c uname -s n --description 'print the nodename (the nodename may be a name that the system is known by to…'
