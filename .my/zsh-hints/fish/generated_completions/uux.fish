# uux
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk/usr/share/man/man1/uux.1
...
complete -c uux -l 'copy).' --description 'If the files are changed before being processed by the uucico (8) daemon, the…'
