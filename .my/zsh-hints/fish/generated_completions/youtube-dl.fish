...
complete -c youtube-dl -l geo-bypass --description 'Bypass geographic restriction via faking X-Forwarded-For HTTP header (experim…'
...
complete -c youtube-dl -l xattr-set-filesize --description 'Set file xattribute ytdl. filesize with expected file size (experimental) .'
...
complete -c youtube-dl -s a -l batch-file --description 'File containing URLs to download (\\[aq]-\\[aq] for stdin) . RS . RE.'
...
complete -c youtube-dl -l prefer-avconv --description 'Prefer avconv over ffmpeg for running the postprocessors (default) . RS . RE.'
complete -c youtube-dl -l prefer-ffmpeg --description 'Prefer ffmpeg over avconv for running the postprocessors . RS . RE.'
...
complete -c youtube-dl -l exec --description 'Execute a command on the file after downloading, similar to find\\[aq]s -exec …'
complete -c youtube-dl -l 'max-sleep-interval.' --description '.'
complete -c youtube-dl -o exec --description 'Example: --exec [aq]adb push {} /sdcard/Music/ && rm {}[aq].'
complete -c youtube-dl -l convert-subs --description 'Convert the subtitles to other format (currently supported: srt|ass|vtt) CONF…'
complete -c youtube-dl -l 'dateafter.' --description 'They accept dates in two formats: [bu] 2 Absolute dates: Dates in the format …'
